...
// Allowed resources
$allowed  = ['bookings', 'schedule', 'tasks', 'notifications', 'gallery', 'gallery_links', 'approvals', 'attendance', 'site_content', 'sign_out_briefs', 'team_members', 'confirmations', 'team_points', 'team_deleted', 'leave_requests', 'team_overrides', 'audit_log', 'invoices'];
