...
(function () {
  ...
  function applyAbout() {
    ...
    const titleEl = document.getElementById('aboutTitle') || q('.about__content .section-title');
    const titleItalicEl = document.getElementById('aboutTitleItalic');
    if (titleItalicEl) {
      if (a.title) titleEl && (titleEl.textContent = a.title);
      if (a.titleItalic) titleItalicEl.textContent = a.titleItalic;
    } else if (titleEl && (a.title || a.titleItalic)) {
    ...
    const para3El = document.getElementById('aboutPara3');
    if (para1El) {
      if (a.para1) para1El.textContent = a.para1;
      if (a.para2 && para2El) para2El.textContent = a.para2;
      if (a.para3 && para3El) {
        para3El.textContent = a.para3;
        para3El.style.display = '';
      }
    } else {
    ...
    if (a.image) {
      ...
      if (imgFront) imgFront.src = a.image;
      if (imgBack)  imgBack.src  = a.image;
    }

    const mIds = [
      { v: 'aboutM1v', l: 'aboutM1l', dv: a.m1v, dl: a.m1l },
      { v: 'aboutM2v', l: 'aboutM2l', dv: a.m2v, dl: a.m2l },
      { v: 'aboutM3v', l: 'aboutM3l', dv: a.m3v, dl: a.m3l },
    ];
    let usedIds = false;
    mIds.forEach(m => {
      const vEl = document.getElementById(m.v);
      const lEl = document.getElementById(m.l);
      if (vEl || lEl) {
        usedIds = true;
        if (vEl && m.dv) vEl.textContent = m.dv;
        if (lEl && m.dl) lEl.textContent = m.dl;
      }
    });
    if (!usedIds) {
