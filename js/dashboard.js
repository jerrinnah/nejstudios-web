...
async function autoCreateEventDayTasks() {
  ...
  for (const b of bookings) {
    ...
    //   Backup     → for studio: Uzo; for event: leave to admin
    //   Lightroom  → for studio: Uzo; for event: leave to admin
    const templates = [
      { title: `Backup ${eventName}`,             deadline: sameDay, priority: 'high',   assignee: isStudio ? UZO : null },
      { title: `Lightroom ${eventName}`,          deadline: plus3,   priority: 'high',   assignee: isStudio ? UZO : null },
      { title: `Create Thriller for ${eventName}`, deadline: plus3,   priority: 'medium', assignee: LIGHT  },
      { title: `Create full video ${eventName}`,   deadline: plus3,   priority: 'medium', assignee: NEJ    },
      { title: `Design Photobook ${eventName}`,    deadline: plus3,   priority: 'medium', assignee: DORATHY },
    ];
    ...
    for (const t of templates) {
      ...
      const newTask = {
        ...
        bookingId:    b.id,
        title:        t.title,
        desc:         `Auto-generated for ${eventName} on ${eventDate}`,
